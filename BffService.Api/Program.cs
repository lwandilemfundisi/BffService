...
app.MapRemoteBffApiEndpoint("/events", new Uri("https://localhost:25965/")).RequireAuthorization("eventsApi-scope").WithAccessToken(RequiredTokenType.User).SkipAntiforgery();
